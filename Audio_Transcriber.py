...
if gui_mode == 'on':
    change_credential = messagebox.askyesno("Audio_Transcriber",
                                            "Would you like to change the default Google Credential?")
    if change_credential:
        filename = filedialog.askopenfilename(
            title='Please Select your credential File')  # show an "Open" dialog box and return the path to the selected file
...
uri = bucket_name + '/audio_data_2'
audio = types.RecognitionAudio(uri='gs://ryan-1801-reb0201-eye-movement-bucket/audio_data_2')
...
for Data_folder in Data_folders:
    ...
    for file in os.listdir(Data_folder):
        ...
        if filename_ext in ['.wav',
                            '.mp3']:  # more audio extensions can be added here. eg:  if filename_ext in ['.wav', '.mp3', '.extension']
            ...
            try:
                ...
                with open(Output_folder + 'full_Information/' + filename_base + '_detailed_transcript.txt',
                          'w') as detailed_output_file:
